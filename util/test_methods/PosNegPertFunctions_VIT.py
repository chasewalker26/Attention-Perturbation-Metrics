...
class PositiveNegativePerturbation():
    ...
    def single_run(self, img_tensor, saliency_map, patch_mask, device, max_batch_size = 50):
        ...
        # Retrieve class predicition of the original image
        ...
        # patches in order of increasing saliency
        elif self.mode == "lerf":
            segment_order = np.argsort(segment_saliency, axis = 0)
